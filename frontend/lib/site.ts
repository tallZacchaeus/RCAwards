...
export const FALLBACK_CATEGORIES: CategorySummary[] = [
  ...
  { slug: "tech-development", name: "Best RCCG Region – Tech Development", group: "regional", description: "Innovation, creativity, and measurable impact in technology." },
  { slug: "youth-development", name: "Best RCCG Region – Youth Development", group: "regional", description: "A region investing in spiritual growth, leadership, and skills for youth." },
  { slug: "sports-development", name: "Best RCCG Region – Sports Development", group: "regional", description: "Promoting sports and wellness for youth engagement and unity." },
  { slug: "agricultural-innovation", name: "Best RCCG Region – Agricultural Innovation", group: "regional", description: "Innovative projects, food security, and agribusiness empowerment." },
  { slug: "departmental-rhv", name: "RHV Department", group: "departmental", description: "Individual excellence in the RHV department." },
  ...
  { slug: "departmental-hospitality", name: "Hospitality Department", group: "departmental", description: "Individual excellence in the Hospitality department." },
  ...
  { slug: "departmental-it", name: "IT Department", group: "departmental", description: "Individual excellence in the IT department." },
